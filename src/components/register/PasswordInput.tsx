    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          className={`bg-color4 w-full rounded-lg border p-2 pr-10 hover:border-gray2 focus:border-primary focus:outline-none ${
        ...
        <button
          ...
          className="absolute right-3 top-1/2 -translate-y-1/2 text-gray1 hover:text-primary"
        >
          {showPassword ? "👁️" : "👁️‍🗨️"}
        </button>
      </div>
